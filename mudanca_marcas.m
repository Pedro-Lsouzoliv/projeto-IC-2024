%Primeiramente, abrir o eeg lab, depois substitua o caminho da pasta nessa
%primeira linha de código
folderpath = 'C:\Users\pokel\Desktop\Pedro\UFBA- Bi cit\Ic UFBA\Base de Dados Espanha\Sets'; %colocar o nome da pasta com os sets
cd(folderpath);
caminhof = "C:\Users\pokel\Desktop\Pedro\UFBA- Bi cit\Ic UFBA\testzinho";
...
for j=1:length(ListaArquivos)
  ...
  [~, name, ext] = fileparts(nomeoriginal);
    novoNome = sprintf('%s_%d%s', name, j, ext); % Cria o novo nome sequencial
